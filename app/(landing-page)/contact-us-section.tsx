    ...
    return (
        <div id="contact-us" className="w-full px-16 py-20">
            <div className="flex flex-col items-center gap-4">
                ...
                {/* Headline */}
                <h2 className="text-5xl md:text-6xl font-base text-white text-center leading-tight">
                    More than just ticketing
                </h2>

                {/* Subtitle */}
                <p className="text-gray-400 text-2xl md:text-2xl font-light text-center max-w-4xl">
                    ...
                    {contactMethods.map((method, index) => {
                        ...
                        return (
                            <Card key={index} className="bg-neutral-900 border-zinc-700 rounded-2xl p-8 py-6 flex flex-col items-center text-center gap-4">
                                ...
                                <h3 className="text-white text-3xl font-base">{method.title}</h3>
                                <p className="text-gray-400 text-xl">{method.description}</p>
                            </Card>
                        )
                    })}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-16">
                    ...
                    <Card className="bg-neutral-950 border-zinc-700 rounded-2xl p-8 flex flex-col gap-4">
